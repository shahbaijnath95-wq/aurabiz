import urllib.request, json, urllib.parse, sys, io, time
...
tests = [
    ("Facial chiya", "pay-test1"),
    ("Gold kit", "pay-test2"),
    ("Gold facial kit", "pay-test3"),
]

for msg, sid in tests:
    chat_data = json.dumps({'business_id': 'c5ac0190-cf9e-46e6-a7a9-7d86d15fcba9', 'message': msg, 'session_id': sid, 'customer_name': 'Repair-it'}).encode()
